...
// Configurazioni con il database e il DictionaryController
...
//funzione per gestire la navigazione tra le pagine dell'area admin
...
//funzione in cui è presente l'interfaccia della pagina di Login
